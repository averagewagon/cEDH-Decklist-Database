...
async function publishChanges() {
  alert("Publishing directly to the site is no longer supported. Edits are saved to the database and will appear on the site once a curator runs the downstream publish step.");
}
