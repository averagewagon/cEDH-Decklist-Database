 (function() {
  ...
  async function readRequests() {
    ...
    populateRequests([{"category": "Request that a deck is removed","date": "2020-07-30T23:09:41.279Z","description": "adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat ","id": "1596150581279krbl"},{"category": "Add, modify, or remove an entry's decklists","date": "2020-07-30T23:07:38.798Z","description": "inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.","id": "1596150458798hwru"},{"category": "Make a correction to a submission","date": "2020-07-30T23:07:22.019Z","description": "This is an example request. inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciu","id": "15961504420193acm"},{"category": "Add, modify, or remove an entry's decklists","date": "2020-07-30T23:08:30.618Z","description": "Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciu","id": "1596150510618mrlx"}]);
  }
  
  function populateRequests(requests) {
    const sortedRequests = requests.sort((a, b) => { return b.date.localeCompare(a.date); });
    const requestList = id("req-list");
